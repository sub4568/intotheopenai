  ...
  return (
    <section className="relative pt-28 pb-8 overflow-hidden bg-page-light">
      <div className="max-w-[760px] mx-auto px-6 relative z-10 text-center">
        ...
        <h1
          className="font-serif text-4xl md:text-5xl lg:text-6xl mb-5 leading-[1.1] text-black tracking-tight opacity-0 animate-fade-up [animation-fill-mode:forwards]"
        >
          The content performance operating system for communications and marketing teams.
        </h1>

        <p
          className="text-base md:text-lg mb-7 leading-relaxed max-w-md mx-auto text-gray-400 opacity-0 animate-fade-up [animation-delay:150ms] [animation-fill-mode:forwards]"
        >
          Predict, test, and optimise content performance before and after publication — powered by a proprietary content performance OS.
        </p>
